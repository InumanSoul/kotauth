...
interface WebhookEndpointRepository {
    ...
    fun findEnabledByTenantAndEvent(tenantId: Int, eventType: String): List<WebhookEndpoint>

    /** Returns a single endpoint scoped to its tenant. */
    fun findById(id: Int, tenantId: Int): WebhookEndpoint?
    ...
    fun setEnabled(id: Int, tenantId: Int, enabled: Boolean)
}
