...
object AdminView {
    ...
    private fun DIV.renderDirectoryCtxPanel(
        workspaceSlug: String?,
    ...
    private fun DIV.renderSecurityCtxPanel(
        workspaceSlug: String?,
        activeSection: String,
    ) {
    ...
    private fun DIV.renderSettingsCtxPanel(
        workspaceSlug: String?,
        activeSection: String,
    ) {
                ...
                div("card card-body") {
                    ...
                    table {
                        tbody {
                            ...
                            detailRow(
                                "Email Verification",
                                if (workspace.emailVerificationRequired) "Required" else "Not required",
                            )
...
(function () {
  ...
  updatePreview();
    ...
    private fun java.time.Instant.toDisplayString(): String = TS_FMT.format(this.atOffset(ZoneOffset.UTC))
