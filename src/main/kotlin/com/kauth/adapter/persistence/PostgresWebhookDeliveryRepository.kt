...
class PostgresWebhookDeliveryRepository : WebhookDeliveryRepository {
    ...
    override fun save(delivery: WebhookDelivery): WebhookDelivery = transaction {
        val insertedId = WebhookDeliveriesTable.insert {
            ...
            it[lastAttemptAt]  = delivery.lastAttemptAt?.let { ts ->
    ...
    override fun update(delivery: WebhookDelivery) = transaction {
    ...
    override fun findByEndpointId(endpointId: Int, limit: Int): List<WebhookDelivery> = transaction {
        WebhookDeliveriesTable.selectAll()
    ...
    override fun findByTenantId(tenantId: Int, limit: Int): List<WebhookDelivery> = transaction {
    ...
    override fun findById(id: Int): WebhookDelivery? = transaction {
        WebhookDeliveriesTable.selectAll()
    ...
    override fun findPending(limit: Int): List<WebhookDelivery> = transaction {
        WebhookDeliveriesTable.selectAll()
