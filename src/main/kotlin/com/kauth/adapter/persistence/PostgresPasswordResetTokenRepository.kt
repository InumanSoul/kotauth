...
class PostgresPasswordResetTokenRepository : PasswordResetTokenRepository {
    ...
    override fun create(token: PasswordResetToken): PasswordResetToken = transaction {
        val insertedId = PasswordResetTokensTable.insert {
    ...
    override fun findByTokenHash(hash: String): PasswordResetToken? = transaction {
    ...
    private fun ResultRow.toToken() = PasswordResetToken(
